...
Run the optional setup once to download and verify the Q8 models (about 2.2
GB):
...
- `SUPER + R` reads the current primary selection from the beginning.
- `SUPER + E` pauses or resumes playback.
